                ...
                //拼接ID
                   ...
                   // window.location="${pageContext.request.contextPath}/prod/deletebatch.action?str="+str;
                    $.ajax({
                        ...
                        data:{"pids":str,"page":ispage,"pname":pname,"typeid":typeid,"lprice":lprice,"hprice":hprice},
                        type:"post",
                        dataType:"text",
        ...
        if (confirm("确定删除吗")) {
          //向服务器提交请求完成删除
                ...
                $.ajax({
                    ...
                    data:{"pid":pid,"page":ispage,"pname":pname,"typeid":typeid,"lprice":lprice,"hprice":hprice},
                    type:"post",
                    success:function (msg) {
                        //重新加载分页显示的组件table
